...
class RaDeGSRendererModule(VanillaRenderer):
    ...
    def _get_opacities_and_scales(self, pc):
        if MipSplattingModel._filter_3d_name in pc.get_property_names():
            return pc.get_3d_filtered_scales_and_opacities()
        return pc.get_opacity, pc.get_scaling
