...
from .mesh_reg import MeshRegularizedMetrics, MeshRegularizedMetricsImpl
...
class InvDepthRegularizedMetricMixinImplmpl:
    ...
    def get_inverse_depth_metric(self, batch, outputs):
        ...
        gt_shape = (int(gt_inverse_depth_data.camera.height), int(gt_inverse_depth_data.camera.width))
...
class InvDepthRegularizedMetricsImpl(InvDepthRegularizedMetricMixinImplmpl, VanillaMetricsImpl):
